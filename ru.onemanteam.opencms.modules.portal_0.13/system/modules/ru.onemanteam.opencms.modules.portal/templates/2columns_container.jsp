...
<!-- me1 -->
<link href="<%= cms.link(moduleBaseUri +  "/resources/css/jquery.formstyler.css") %>" rel="stylesheet" />
<link rel="stylesheet" type="text/css" href="<%= cms.link(moduleBaseUri +  "/resources/css/slickmap.css") %>">
<script src="<%= cms.link(moduleBaseUri + "/resources/js/jquery.formstyler.min.js") %>"></script>
<style>
...
<cms:container name="page-complete" type="page" tagClass="grid_17 centercolumn" width="1200" maxElements="15" editableby="ROLE.DEVELOPER">
